...
| ---------------- | -------------------------------------------------------------------------------------------- | ------------- | -------------------- |
| Formatters       | newlines, mixed_line_ending, trailing_whitespace, shfmt, taplo_format, rumdl, yamlfmt, typos | owned files   | run `fix` + restage  |
| Linters          | shellcheck, taplo                                                                            | owned files   | check only           |
